...
export default function MyInvoices({ shipments }: Props) {
    ...
    const totalSpent = shipments.data.reduce((sum, shipment) => sum + shipment.price, 0);
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Download and manage invoices for your paid shipments
                        </p>
                    </div>
                </div>
                    ...
                    <CardContent>
                        ...
                        {shipments.data.length === 0 && (
                            <div className="text-center py-8 text-muted-foreground">
                                ...
                                <p className="text-sm">Invoices will appear here once you make payments for your
                                    shipments.</p>
